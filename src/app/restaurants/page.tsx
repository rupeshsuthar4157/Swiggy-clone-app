...
import { GoArrowLeft } from "react-icons/go";import {
...
const Page = () => {
  ...
  return (
    <div className=" bg-white min-h-screen relative">
      {/* Navbar */}
      <header className="hidden lg:block w-full shadow-sm bg-white">
      ...
      <header className="lg:hidden fixed top-0 w-full shadow-sm z-50 bg-white">
        <div className="container mx-auto flex items-center justify-between px-4 md:px-10 py-3 flex-wrap gap-4">
          ...
          size={20}/>
            ...
            >
              <div className="group inline-block">
                <p className="text-[17px] font-semibold text-black group-hover:text-[#FF5504]">
                  other
                </p>
              </div>
              <span className="text-sm text-[#808285] truncate group-hover:opacity-50">
      ...
      >
        ...
        <div className="p-6">
          ...
          <div>
            <p className="mt-4 border text-[16px] text-[#fffff] font-bold py-3 w-82 flex item-center justify-center bg-[#FF5504]">
              Login
            </p>
