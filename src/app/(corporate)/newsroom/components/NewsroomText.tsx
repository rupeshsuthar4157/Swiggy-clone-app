...
export default function NewsroomText() {
    const Delevery = "Newsroom"
    const SecondText = "Announcements and updates at Swiggy"
        ...
        <section className="w-full py-16">
            <div className="max-w-5xl mx-auto px-4">
                ...
                >
                    ...
                    <span className="mt-4 relative font-medium block  text-[#8A8A8D] text-xl">{SecondText}</span>
